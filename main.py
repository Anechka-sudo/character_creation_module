...
def attack(char_name: str, char_class: str) -> str:
    """Подсчет очков действия атаки игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Подсчет очков действия защиты игрока."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Подсчет очков действия суперсилы игрока."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция выбора действий игрока: атака, защита или.
    применение суперсилы.
    """
    if char_class == 'warrior':
    ...
    print('Введи одну из команд: attack — чтобы атаковать противника,'
          ' defence — чтобы блокировать атаку противника и'
...
def choice_char_class() -> str:
    """Игрок должен выбрать и ввести название персонажа."""
    approve_choice: str = ''
    char_class: str = ''
